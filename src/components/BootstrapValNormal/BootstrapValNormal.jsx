...
function BootstrapValNormal() {
  ...
  return (
    <section>
      <div className="mb-5">
        <h1 className="font-bold">BOOTSTRAP VALIDATION - NORMAL</h1>
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          ...
          <Form.Group as={Col} md="12" className="mt-4" controlId="validationCustom02">
          ...
          <Form.Group as={Col} md="12" className="mt-4" controlId="validationCustomUsername">
...
export default BootstrapValNormal;
