          ...
          <table className="min-w-full divide-y divide-gray-300 ">
            <thead className="bg-white">
              <tr className="rounded-t-xl">
                ...
                <th
                  scope="col"
                  className="px-3 py-3.5 font-bold text-sm flex items-center gap-4"
                >
                ...
                <th
                  scope="col"
                  className="px-3 py-3.5 text-left font-bold text-sm items-center gap-4"
                >
